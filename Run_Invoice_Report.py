...
class InvoiceProcessor:
    ...
    def categorize_invoices(self):
        ...
        """
        label_conditions = {
            lambda row: row['Source'] == 'AP2' and row['Contract'] == 8986: "Charts & Coding",
            lambda row: row['Source'] == 'AP2' and row['Contract'] == 8999: "Misc. exp.",
            lambda row: row['Source'] == 'COR' and row['Contract'] == 8986 and row['Amount'] < 0: "8986 Coupa Reversal",
            lambda row: row['Source'] == 'COR' and row['Contract'] == 8986 and row['Amount'] > 0: "8986 Coupa Pending",
            lambda row: row['Source'] == 'COR' and row['Contract'] == 8999 and row['Amount'] < 0: "8999 Coupa Reversal",
            lambda row: row['Source'] == 'COR' and row['Contract'] == 8999 and row['Amount'] > 0: "8999 Coupa Pending"
        }
